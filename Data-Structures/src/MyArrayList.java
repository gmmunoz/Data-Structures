...
public class MyArrayList <AnyType> implements Iterable<AnyType> {
		...
		/***
		 * Returns true if this collection is empty.* @return true if this
		 * collection is empty.
		 */
		 ...
		 * in.* @throws ArrayIndexOutOfBoundsException if index is out of range.
		 */
		 ...
		 * value.* @throws ArrayIndexOutOfBoundsException if index is out of
		 * range.
		 */
		...
		/***
		 * Adds an item to this collection, at the specified index.* @param x
		...
		/***
		 * Removes an item from this collection.* @param idx the index of the
		 * object.* @return the item was removed from the collection.
		 */
